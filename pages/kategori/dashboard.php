...
<div class="row">
    <div class="col-lg-12 mb-4">
        <div class="card shadow mb-4">
            ...
            <div class="card-body">
                <p>Ini adalah halaman dashboard utama. Dari sini kamu bisa memantau jumlah barang dan kategori di sistem.</p>
                <p>Gunakan menu di sidebar untuk mengelola daftar barang, menambah data baru, atau melihat halaman lainnya.</p>
            </div>
        </div>
    </div>
</div>
